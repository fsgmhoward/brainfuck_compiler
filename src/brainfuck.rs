...
mod __parse__Ops {
    ...
    {
        match *__token {
            Token::Plus if true => Some(0),
            Token::Output if true => Some(1),
            Token::Minus if true => Some(2),
            Token::Input if true => Some(3),
            Token::Left if true => Some(4),
            Token::Right if true => Some(5),
            Token::LoopStart if true => Some(6),
            Token::LoopEnd if true => Some(7),
            _ => None,
        }
    }
    ...
    pub struct OpsParser {
        _priv: (),
    }

    impl Default for OpsParser { fn default() -> Self { Self::new() } }
    impl OpsParser {
        pub fn new() -> OpsParser {
            OpsParser {
                _priv: (),
            }
        }
        ...
        >(
            &self,
            __tokens0: __TOKENS,
        ) -> Result<Vec<Op>, __lalrpop_util::ParseError<usize, Token, String>>
        {
    ...
    >(
        ...
        _: core::marker::PhantomData<()>,
    ) -> Option<Result<Vec<Op>,__lalrpop_util::ParseError<usize, Token, String>>>
    {
...
#[allow(unused_imports)]
pub use self::__parse__Ops::OpsParser;

#[allow(clippy::too_many_arguments, clippy::needless_lifetimes, clippy::just_underscores_and_digits)]
fn __action0<
>(
    (_, __0, _): (usize, Vec<Op>, usize),
) -> Vec<Op>
{
    __0
}
...
fn __action2<
>(
    (_, mut prev, _): (usize, Vec<Op>, usize),
    (_, mut op, _): (usize, Op, usize),
) -> Vec<Op>
{
    {
    // Fold arithmatic ops
...
>(
    ...
    (_, loop_body, _): (usize, Vec<Op>, usize),
    (_, _, _): (usize, Token, usize),
) -> Op
{
    Op::Loop(loop_body)
